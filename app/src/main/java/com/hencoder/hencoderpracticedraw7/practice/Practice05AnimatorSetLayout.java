...
//                animatorSet.playSequentially(animator1,animator2,animator3);//从前到后依次播放
//                animatorSet.playTogether(animator1,animator2,animator3);//一起播放
                animatorSet.play(animator1).before(animator2);//先执行animator1,再执行animator2
