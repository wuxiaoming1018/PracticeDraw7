    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyframe1 = Keyframe.ofFloat(0,0);//以0作为起始数值
                Keyframe keyframe2 = Keyframe.ofFloat(0.5f,100);//时间过半的时候，数值达到100
                Keyframe keyframe3 = Keyframe.ofFloat(1,80);//时间完成的时候，数值退回到80
